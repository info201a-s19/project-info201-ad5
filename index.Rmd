...
The purpose of this line plot is to show the trend of the impact on humans from the years 1980 to 2019. It will also aid in resolving our question regarding the trends throughout the years and using that information to predict and map out hazardous locations. VEI in this bar plot refers to the amount of magma that erupts out of a volcano.
