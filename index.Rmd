...
The table hopes to explain out of the eruptions with recorded VEI's, what was the average for each year? Also, what number of incidents per year did not have recorded incidents? All of this would be grouped by the year, allowing the viewer to see a volcano activity lull in some years prior.
...
The purpose of this bar plot is to show the trend of the impact on humans from the years 1980 to 2000. It will also aid in resolving our question regarding the trends throughout the years and using that information to predict and map out hazardous locations. VEI in this bar plot refers to the amount of magma that erupts out of a volcano.
